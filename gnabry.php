...
<body>
    <img class="pic" src="img/gnabry.webp" alt="">
    <h2>Serge Gnabry</h2>
    <table bgcolor="black" >
        <tr bgcolor="RoyalBlue" align="center">
            <th width="150">Výška</th>
            <th width="150">Pozícia</th>
            <th width="150">Dátum narodenia</th>
            <th width="150">Celé meno</th>
            <th width="150">Miesto Narodenia</th>
        </tr>
        <tr bgcolor="RoyalBlue "align="center">
            <td>176 cm</td>
            <td>útočník</td>
            <td>14. júl 1995</td>
            <td>Serge David Gnabry</td>
            <td>Stuttgart, Nemecko</td>
        </tr>
    </table>
